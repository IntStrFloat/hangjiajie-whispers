      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20 py-8 md:py-12 max-w-3xl">
        ...
        <article className="prose prose-neutral dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              Цифровой товар — информационный продукт в формате гайда («Гайд по
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              Оплата принимается через платёжный сервис ЮKassa (НКО «ЮМани»)
              способами, доступными на странице оплаты. Моментом оплаты
              считается успешное зачисление средств. При возникновении
